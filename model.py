...
class InvertedResidualBlock(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, stride, padding, expand_ratio,
        ...
        reduced_dim = int(hidden_dim / reduction)  # int(in_channels/reduction) #
        if self.expand:
            self.expand_conv = CNNBlock(in_channels, hidden_dim, kernel_size=3, stride=1, padding=1)  # kernel_size 1?
...
class EfficientNet(nn.Module):
    ...
    def calculate_factors(selfself, version, alpha=1.2, beta=1.1):
